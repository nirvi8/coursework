...
```{r load-counts}
year_count <- read_tsv('year_counts.tsv',col_names = c('term','year','volume','book_count'))
...
year_total %>% filter(year>= 1850,year >= 2012,term==c(1883,1910,1950))%>%select(year,volume,term)
